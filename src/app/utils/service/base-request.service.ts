...
export class BaseRequestService {
  ...
  get(url): Observable<any> {
    ...
    return this._http.get(`${this.basePatch}${url}`, headers)
      .pipe(
        map(res => { return res }),
  ...
  put(url: string, data: any): Observable<any> {
    const headers = this.httpOptions();
    return this._http.put(`${this.basePatch}${url}`, data, headers)
      .pipe(
        map(res => { return res }),
        catchError(this.handleError)
      );
  ...
  delete(url: string): Observable<any> {
    const headers = this.httpOptions();
    return this._http.delete(`${this.basePatch}${url}`, headers)
      .pipe(
        map(res => { return res }),
        catchError(this.handleError)
      );
  ...
  private httpOptions(): any {
    ...
    const headers = !!this.token ? new HttpHeaders()
